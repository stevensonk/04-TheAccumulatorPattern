...
def run_test_factorial():
    ...
    # Test 4:
    expected = math.factorial(16)
    answer = factorial(16)
    print('Test 4 expected (from oracle):', expected)
    print('         actual (from my code):', answer)

    # Test 5:
    expected = math.factorial(62)
    answer = factorial(62)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(1, 6, 0.43)
    print('Test 2 expected:', expected)
    print('         actual:', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(5, 8, 0.91)
    print('Test 3 expected:', expected)
    print('         actual:', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(2, 5, 0.33)
    print('Test 4 expected:', expected)
    print('         actual:', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(5, 7, 0.84)
    print('Test 5 expected:', expected)
    print('         actual:', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(1, 1, 0.5)
